  ...
  return (
    <div>
      <div className="page-header">
        ...
        {/* Navegador de Año */}
        <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', justifyContent: 'center', width: '100%', backgroundColor: '#ffffff', border: '1px solid var(--border-color)', borderRadius: '0.5rem', padding: '0.25rem 0.75rem' }}>
          <button 
            className="close-btn" 
