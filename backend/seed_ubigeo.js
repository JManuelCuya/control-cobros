...
async function main() {
  console.log('Seeding Pais and Departamentos...');
  
  // 1. Create Pais (Peru = 15)
  await prisma.pais.upsert({
    where: { id: 15 },
    update: { descripcion: 'Perú' },
    create: { id: 15, descripcion: 'Perú' }
  });
  console.log('Pais Perú created (ID: 15)');
  ...
  console.log('25 Departamentos created/updated successfully.');
}
